...
public partial class CliArgsCommandBuilder
{
    ...
    {
        this.Object.Value.CliStartInfo.Env = new Dictionary<string, string?>(env);
        return this;
    }
    ...
    {
        this.Object.Value.CliStartInfo.Env ??= new Dictionary<string, string?>();
        this.Object.Value.CliStartInfo.Env[name] = value;
        return this;
    }
